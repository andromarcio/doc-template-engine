...
- Intake de história (PROMPT_BACKLOG): `[INICIALIZACAO]` → `[INTAKE_HISTORIA]` → `[ROTEAMENTO]` → `[GERACAO_ARTEFATO_HU]`
...
PROMPT_BACKLOG → modules/_backlog/[chave].md (entrada — história do ServiceNow; origina os N3)
